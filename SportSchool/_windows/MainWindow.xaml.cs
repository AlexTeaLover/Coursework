...
namespace SportSchool
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (documentTab.IsSelected)
            {
                documentGrid.ItemsSource = _context.Documents
                    .Join(_context.Employees, d => d.SignedBy, e => e.Id, (d, e) => new { d, e.Name })
                    .Where(d => d.Name.Contains(signedByTextBox.Text))
                    .Where(d => d.d.Name.Contains(documentName.Text)).ToList(); return;
            }
        }
        ...
        private void UpdateGrids()
        {
            ...
            documentGrid.ItemsSource = _context.Documents.Join(_context.Employees, d => d.SignedBy, e => e.Id, (d, e) => new { d, e.Name }).ToList();
        }
    }
}